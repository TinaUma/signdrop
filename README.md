...
![Интерфейс — документ с подписью и рукописным текстом](screenshots/01-interface.png)

*Подпись и рукописный текст наложены на документ — всё локально, без облаков*

![История подписей](screenshots/02-signature-history.png)

*Диалог истории подписей — быстрый выбор ранее использованных*
...
*Навигация по страницам — подпись на любой странице PDF*
