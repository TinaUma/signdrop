...
*Signing history — list of documents you have already signed*
...
*"Apply to all pages" — signature appears on every page instantly. "Exclude page" — skip the cover page, for example*
