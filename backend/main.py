...
# those known origins instead of "*" (the API is unauthenticated). A deployment
# behind a custom domain can add origins via the CORS_ALLOWED_ORIGINS env var
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=ALLOWED_ORIGINS + cors_extra_origins(),
